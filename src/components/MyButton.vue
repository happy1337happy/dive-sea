...
import { useImageLoader } from '@/assets/composables/useImageLoader';
    ...
    const props= defineProps ({
        ...
        size:{
            type:String,
            default:'md',
            validator:(prop) => ['xsm','sm','md','lg','xlg','ban','modal','upload','full','sigma'].includes(prop)
        },
        font: { 
            type: String,
            default: 'poppins',
        ...
        fontSize: {
            type: String,
            default: 'md',
            validator: (prop) => ['xsm','sm', 'md','lg','xlg','modaltext','card','rem'].includes(prop)
        },
        iconPosition: { 
            type: String,
            default: 'left',
        ...
        gap: {
            type: String,
            default: '16px',
            validator: (prop) => ['11px','14px','16px'].includes(prop)
        },
...
<style lang="scss">
    .btn-dude{
        ...
        &.size-sigma {
            width: 100%;
            padding: clamp(0.625rem, 1.5vw, 0.9375rem) clamp(1.0625rem, 2vw, 1.5625rem);
        }
        ...
        &.font-size-rem {
            font-size: clamp(0.625rem, 2vw, 0.9375rem);
            line-height: 100%;
        }
        &.icon-right {
            .btn-icon {
